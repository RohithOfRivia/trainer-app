...
<aside class="hidden md:flex flex-col items-center h-screen sticky top-0 overflow-y-auto space-y-4 py-6 px-2 bg-base-300
    ...
    <ul class="w-full flex flex-col">
        <li>
            ...
            >
                <span class="material-symbols-outlined shrink-0 text-center">menu</span>
            </button>
        </li>
